    ...
    public static class Json
    {
        ...
        sealed class Serializer
        {
            ...
            void SerializeValue(object value)
            {
                ...
                else if (value is IList list) { SerializeArray(list); }
                else if (value is IDictionary dict) { SerializeObject(dict); }
                else if (value is char c) { SerializeString(new string(c, 1)); }
            ...
            {
                if (value is float f) builder.Append(f.ToString("R", System.Globalization.CultureInfo.InvariantCulture));
                else if (value is double d) builder.Append(d.ToString("R", System.Globalization.CultureInfo.InvariantCulture));
                ...
                else if (value is decimal dec) builder.Append(dec.ToString(System.Globalization.CultureInfo.InvariantCulture));
